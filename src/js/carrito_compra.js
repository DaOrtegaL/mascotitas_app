document.addEventListener('DOMContentLoaded', () => {
  ...
  document
    ...
    .addEventListener('click', function () {
      document
        ...
        .classList.add('open_formulario');
      document.querySelector('.carrito__lista').classList.add('close_carrito');
      document.getElementById('continuarPago').classList.add('close');
    });
  ...
  const mismaInfoCheckbox = document.getElementById('misma-info');
  const envioInputs = document.querySelectorAll(
    '.formulario-compra__seccion--envio .formulario-compra__input',
  );

  mismaInfoCheckbox.addEventListener('change', () => {
    if (mismaInfoCheckbox.checked) {
